...
export function createMcpError(error: unknown, fallback = 'GitNexus MCP request failed.'): Error {
...
/**
 * Legacy singleton MCP client instance using stdio transport.
 * Uses a lazy proxy to avoid circular dependency issues at module load time.
 */
export const mcpClient: McpClient = createLazyStdioClient();
